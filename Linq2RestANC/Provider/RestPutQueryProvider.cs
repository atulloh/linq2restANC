...
namespace Linq2Rest.Provider
{
	...
	internal class RestPutQueryProvider<T> : RestQueryProvider<T>
	{
		...
		public RestPutQueryProvider(IRestClient client, ISerializerFactory serializerFactory, IExpressionProcessor expressionProcessor, IMemberNameResolver memberNameResolver, IEnumerable<IValueWriter> valueWriters, IEnumerable<IMethodCallWriter> methodCallWriters, Stream inputData, Type sourceType)
		...
		private IQueryable<TResult> InnerCreateQueryable<TResult>(IRestClient client, ISerializerFactory serializerFactory, IMemberNameResolver memberNameResolver, IEnumerable<IValueWriter> valueWriters, IEnumerable<IMethodCallWriter> methodCallWriters, Expression expression, Type sourceType)
		{
			...
			return new RestGetQueryable<TResult>(client, serializerFactory, memberNameResolver, valueWriters, methodCallWriters, sourceType, expression);
		}
